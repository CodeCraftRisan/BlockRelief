...
# --- File Paths ---
SURVEY_DATA_PATH = '../data/Fuzzy_AHP_Survey_Responses.csv'
VERIFIED_VICTIMS_PATH = '../data/verified_victims.csv'
...
def calculate_fuzzy_ahp_weights():
    ...
    results.to_csv('../data/fuzzy_ahp_weights.csv', index=False)
    print(f"\nWeights saved to '../data/fuzzy_ahp_weights.csv'")
...
def calculate_vulnerability_scores(weights_dict):
    ...
    victims_df['Norm_House'] = victims_df['House_Type'] / 3.0
