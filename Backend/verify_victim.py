...
# --- File Paths ---
BASELINE_DB_PATH = '../data/National_ID_Database.csv'
VOLUNTEER_INPUT_PATH = '../data/volunteer_input.csv'
VERIFIED_OUTPUT_PATH = '../data/verified_victims.csv'
REJECTED_OUTPUT_PATH = '../data/rejected_entries.csv'
VERIFICATION_REPORT_PATH = '../data/verification_report.txt'
